import type {Expression, EvaluationContext, Type, ZoomConstantExpression} from '@terralytica/maplibre-gl-style-spec';
import {NullType} from '@terralytica/maplibre-gl-style-spec';
